...
namespace MyApp.Api.Controllers
{
    ...
    public class EmployeesController(ISender sender) : ControllerBase
    {
        ...
        {
            IEnumerable<EmployeeEntity> result = await sender.Send(new GetAllEmployeesQuery());
        ...
        {
            EmployeeEntity result = await sender.Send(new GetEmployeeByIdQuery(employeeId));
        ...
        public async Task<IActionResult> UpdateEmployeeAsync([FromRoute] Guid employeeId,
            [FromBody] EmployeeEntity employee)
        {
            EmployeeEntity result = await sender.Send(new UpdateEmployeeCommand(employeeId, employee));
        ...
        {
            bool result = await sender.Send(new DeleteEmployeeCommand(employeeId));
